...
public class MBThreadServiceHttp {
	...
	public static java.util.List<com.liferay.message.boards.model.MBThread>
		...
		try {
			MethodKey methodKey = new MethodKey(
				MBThreadServiceUtil.class, "getThreadsNoRanting",
				_getThreadsNoRantingParameterTypes12);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, groupId, categoryId, start, end);
	...
	private static final Class<?>[] _getThreadsNoRantingParameterTypes12 =
