...
public class MBThreadServiceHttp {
	...
	public static java.util.List<com.liferay.message.boards.model.MBThread>
		findNotAnsweredThreads(HttpPrincipal httpPrincipal, long groupId) {

		try {
			MethodKey methodKey = new MethodKey(
				MBThreadServiceUtil.class, "findNotAnsweredThreads",
				_findNotAnsweredThreadsParameterTypes6);
	...
	public static java.util.List<com.liferay.message.boards.model.MBThread>
		findBySectionNotAnsweredThreads(
			HttpPrincipal httpPrincipal, long groupId, long categoryId) {

		try {
			MethodKey methodKey = new MethodKey(
				MBThreadServiceUtil.class, "findBySectionNotAnsweredThreads",
				_findBySectionNotAnsweredThreadsParameterTypes7);
	...
	private static final Class<?>[] _findNotAnsweredThreadsParameterTypes6 =
		new Class[] {long.class};
	private static final Class<?>[]
		_findBySectionNotAnsweredThreadsParameterTypes7 = new Class[] {
