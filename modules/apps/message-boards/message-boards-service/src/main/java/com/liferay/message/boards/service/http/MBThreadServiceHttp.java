...
public class MBThreadServiceHttp {
	...
	public static java.util.List<com.liferay.message.boards.model.MBThread>
		getNotAnsweredThreads(HttpPrincipal httpPrincipal, long groupId) {

		try {
			MethodKey methodKey = new MethodKey(
				MBThreadServiceUtil.class, "getNotAnsweredThreads",
				_getNotAnsweredThreadsParameterTypes5);
	...
	public static java.util.List<com.liferay.message.boards.model.MBThread>
		getBySectionNotAnsweredThreads(
			HttpPrincipal httpPrincipal, long groupId, long categoryId) {

		try {
			MethodKey methodKey = new MethodKey(
				MBThreadServiceUtil.class, "getBySectionNotAnsweredThreads",
				_getBySectionNotAnsweredThreadsParameterTypes6);
	...
	public static java.util.List<com.liferay.message.boards.model.MBThread>
		...
		try {
			MethodKey methodKey = new MethodKey(
				MBThreadServiceUtil.class, "getGroupThreads",
				_getGroupThreadsParameterTypes7);
	...
	public static int getGroupThreadsCount(
		...
		try {
			MethodKey methodKey = new MethodKey(
				MBThreadServiceUtil.class, "getGroupThreadsCount",
				_getGroupThreadsCountParameterTypes12);
	...
	private static final Class<?>[] _getNotAnsweredThreadsParameterTypes5 =
		new Class[] {long.class};
	private static final Class<?>[]
		_getBySectionNotAnsweredThreadsParameterTypes6 = new Class[] {
			long.class, long.class
		};
	private static final Class<?>[] _getGroupThreadsParameterTypes7 =
	...
	private static final Class<?>[] _getGroupThreadsCountParameterTypes12 =
		new Class[] {
			long.class, long.class, int.class, boolean.class, boolean.class
		};
