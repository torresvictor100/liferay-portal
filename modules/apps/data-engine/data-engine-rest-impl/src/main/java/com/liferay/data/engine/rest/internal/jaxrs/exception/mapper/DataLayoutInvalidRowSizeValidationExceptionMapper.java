...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Data.Engine.REST.DataLayoutInvalidRowSizeValidationExceptionMapper"
	},
...
public class DataLayoutInvalidRowSizeValidationExceptionMapper
	...
	protected Problem getProblem(
		DataLayoutValidationException.InvalidRowSize invalidRowSize) {

		return new Problem(invalidRowSize);
	}
