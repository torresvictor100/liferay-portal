 ...
 */
@Component(
	property = "resource.locator.key=/headless-commerce-admin-catalog/v1.0/LowStockAction",
	service = LowStockActionResource.Factory.class
)
@Generated("")
public class LowStockActionResourceFactoryImpl
	implements LowStockActionResource.Factory {

	@Override
	public LowStockActionResource.Builder create() {
		return new LowStockActionResource.Builder() {
			...
			@Override
			public LowStockActionResource.Builder checkPermissions(
			...
			@Override
			public LowStockActionResource.Builder httpServletRequest(
			...
			@Override
			public LowStockActionResource.Builder httpServletResponse(
			...
			@Override
			public LowStockActionResource.Builder preferredLocale(
			...
			@Override
			public LowStockActionResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, LowStockActionResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			LowStockActionResource.class.getClassLoader(),
			LowStockActionResource.class);

		try {
			Constructor<LowStockActionResource> constructor =
				(Constructor<LowStockActionResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(lowStockActionResource);
