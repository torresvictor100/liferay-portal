...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Admin.Address.CountryNameExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class CountryNameExceptionMapper
	extends BaseExceptionMapper<CountryNameException> {
