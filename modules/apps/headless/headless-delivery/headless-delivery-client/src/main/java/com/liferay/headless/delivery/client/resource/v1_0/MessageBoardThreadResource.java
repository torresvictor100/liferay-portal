...
public interface MessageBoardThreadResource {
	...
	public static class MessageBoardThreadResourceImpl
		...
		public HttpInvoker.HttpResponse
			...
			if (fields != null) {
				httpInvoker.parameter("fields", String.valueOf(fields));
			}

			if (restrictedFields != null) {
				httpInvoker.parameter(
					"restrictedFields", String.valueOf(restrictedFields));
			}
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-delivery/v1.0/message-board-section/{messageBoardSectionId}/not-answered-threads");
