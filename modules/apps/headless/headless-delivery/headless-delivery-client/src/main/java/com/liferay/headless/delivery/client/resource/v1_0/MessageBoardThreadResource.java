...
public interface MessageBoardThreadResource {
	...
	public HttpInvoker.HttpResponse
			getMessageBoardSectionNotAcceptedAnswerThreadsPageHttpResponse(
				Long messageBoardSectionId, String search,
				List<String> aggregations, String filterString,
				Pagination pagination, String sortString)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getMessageBoardSectionNotAnsweredThreadsPageHttpResponse(
				Long messageBoardSectionId, String search,
				List<String> aggregations, String filterString,
				Pagination pagination, String sortString)
		throws Exception;
	...
	public static class MessageBoardThreadResourceImpl
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-delivery/v1.0/message-board-sections/{messageBoardSectionId}/not-accepted-answer-threads");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-delivery/v1.0/message-board-sections/{messageBoardSectionId}/not-answered-threads");
