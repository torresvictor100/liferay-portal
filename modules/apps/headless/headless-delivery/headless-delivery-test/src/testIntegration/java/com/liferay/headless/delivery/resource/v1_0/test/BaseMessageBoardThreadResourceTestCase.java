...
public abstract class BaseMessageBoardThreadResourceTestCase {
	...
	@Test
	public void testGetMessageBoardThreadsNotAnsweredThreadsPage()
		throws Exception {

		Long messageBoardSectionId =
			testGetMessageBoardThreadsNotAnsweredThreadsPage_getMessageBoardSectionId();
		Long irrelevantMessageBoardSectionId =
			testGetMessageBoardThreadsNotAnsweredThreadsPage_getIrrelevantMessageBoardSectionId();
		...
		if (irrelevantMessageBoardSectionId != null) {
			MessageBoardThread irrelevantMessageBoardThread =
				testGetMessageBoardThreadsNotAnsweredThreadsPage_addMessageBoardThread(
					irrelevantMessageBoardSectionId,
					randomIrrelevantMessageBoardThread());
	...
	@Test
	public void testGetMessageBoardThreadsNotAnsweredThreadsPageWithFilterDateTimeEquals()
		throws Exception {
	...
	@Test
	public void testGetMessageBoardThreadsNotAnsweredThreadsPageWithFilterDoubleEquals()
		throws Exception {
	...
	@Test
	public void testGetMessageBoardThreadsNotAnsweredThreadsPageWithFilterStringEquals()
		throws Exception {
	...
	@Test
	public void testGetMessageBoardThreadsNotAnsweredThreadsPageWithPagination()
		throws Exception {
	...
	@Test
	public void testGetMessageBoardThreadsNotAnsweredThreadsPageWithSortDateTime()
		throws Exception {

		testGetMessageBoardThreadsNotAnsweredThreadsPageWithSort(
			EntityField.Type.DATE_TIME,
			(entityField, messageBoardThread1, messageBoardThread2) -> {
				BeanTestUtil.setProperty(
					messageBoardThread1, entityField.getName(),
	...
	@Test
	public void testGetMessageBoardThreadsNotAnsweredThreadsPageWithSortDouble()
		throws Exception {
	...
	@Test
	public void testGetMessageBoardThreadsNotAnsweredThreadsPageWithSortInteger()
		throws Exception {
	...
	@Test
	public void testGetMessageBoardThreadsNotAnsweredThreadsPageWithSortString()
		throws Exception {
	...
	protected void testGetMessageBoardThreadsNotAnsweredThreadsPageWithSort(
			EntityField.Type type,
			UnsafeTriConsumer
				<EntityField, MessageBoardThread, MessageBoardThread, Exception>
					unsafeTriConsumer)
