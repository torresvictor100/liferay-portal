...
public class OrganizationEntityModel implements EntityModel {
	...
	protected void activate(BundleContext bundleContext) {
		...
		_entityFieldsMap = EntityModel.toEntityFieldsMap(
			new LazyComplexEntityField("customField"),
	...
	private Map<String, EntityField> _createEntityFieldsMap() {
		_serviceRegistration = _bundleContext.registerService(
			ModelListener.class, new OrganizationExpandoColumnModelListener(),
			null);
	...
	private class LazyComplexEntityField extends ComplexEntityField {
		...
		public Map<String, EntityField> getEntityFieldsMap() {
			return _entityFieldsMapDCLSingleton.getSingleton(
				OrganizationEntityModel.this::_createEntityFieldsMap);
		}
	...
	private class OrganizationExpandoColumnModelListener
